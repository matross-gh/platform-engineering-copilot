...
namespace Platform.Engineering.Copilot.Agents.Services.Engines.Cost;
    ...
    public class CostOptimizationEngine : ICostOptimizationEngine
    {
        ...
        public async Task<CostAnalysisResult> AnalyzeSubscriptionAsync(string subscriptionId)
        {
            ...
            try
            {
                ...
                var resources = await _resourceService.ListAllResourcesAsync(subscriptionId, CancellationToken.None);
