...
namespace Platform.Engineering.Copilot.Agents.Compliance.Services.Data;
...
public class AssessmentService : IAssessmentService
{
    ...
    private static ComplianceFinding MapFindingToEntity(string assessmentId, AtoFinding finding)
    {
        return new ComplianceFinding
        {
            ...
            ControlId = finding.AffectedNistControls.FirstOrDefault() ?? finding.AffectedControls.FirstOrDefault(),
