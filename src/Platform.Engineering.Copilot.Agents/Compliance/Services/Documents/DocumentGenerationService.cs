...
public class DocumentGenerationService : IDocumentGenerationService
{
        ...
        IChatClient? chatClient = null)
    {
        ...
        if (_options.EnableAIGeneration && _chatClient != null)
        {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (_chatClient != null && control != null)
        {
            try
            {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (_chatClient != null && assessment != null)
        {
...
5. Provides confidence in the system's security";
            ...
            return response.Text ?? GenerateTemplateExecutiveSummary(assessment, parameters);
        }
        catch (Exception ex)
        {
...
Use clear language suitable for management review.";
            ...
            return response.Text ?? GenerateTemplateRiskNarrative(finding);
        }
        catch (Exception ex)
        {
