...
namespace Platform.Engineering.Copilot.Compliance.Agent.Services.Governance;
...
public class GovernanceEngine : IGovernanceEngine
{
    ...
    /// <summary>
    /// Convert infrastructure provisioning request to MCP tool call for policy evaluation
    /// </summary>
