...
/// <summary>
/// Interface for infrastructure-based auto-remediation of compliance findings
/// Handles automated fixes for Azure resources, policies, and configurations
/// </summary>
public interface IInfrastructureRemediationService
{
    /// <summary>
    /// Determines if a finding can be automatically remediated through infrastructure changes
    /// </summary>
