...
/// <summary>
/// Service interface for managing Navy Flankspeed mission owner ServiceCreation requests
/// </summary>
public interface IServiceCreationService
{
    ...
    /// <summary>
    /// Creates a new draft ServiceCreation request
    /// </summary>
    ...
    /// <summary>
    /// Updates a draft ServiceCreation request with new data
    /// </summary>
    ...
    /// <param name="requestId">The request ID</param>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>The ServiceCreation request or null if not found</returns>
    ...
    /// <summary>
    /// Approves an ServiceCreation request and triggers provisioning
    /// </summary>
    /// <param name="requestId">The request ID</param>
    ...
    /// <summary>
    /// Gets ServiceCreation statistics for dashboard
    /// </summary>
    /// <param name="cancellationToken">Cancellation token</param>
...
/// <summary>
/// Trend data for ServiceCreation metrics
/// </summary>
