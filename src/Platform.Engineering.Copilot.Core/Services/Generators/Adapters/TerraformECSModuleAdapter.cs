...
/// <summary>
/// Adapter for TerraformAKSModuleGenerator to work with the unified orchestrator
/// </summary>
public class TerraformAKSModuleAdapter : ModuleGeneratorBase
{
    private readonly TerraformAKSModuleGenerator _generator = new();
...
/// <summary>
/// Adapter for TerraformAppServiceModuleGenerator to work with the unified orchestrator
/// </summary>
public class TerraformAppServiceModuleAdapter : ModuleGeneratorBase
{
    private readonly TerraformAppServiceModuleGenerator _generator = new();
...
/// <summary>
/// Adapter for TerraformAzureContainerInstancesModuleGenerator to work with the unified orchestrator
/// </summary>
public class TerraformContainerInstancesModuleAdapter : ModuleGeneratorBase
{
    private readonly TerraformAzureContainerInstancesModuleGenerator _generator = new();
