...
namespace Platform.Engineering.Copilot.Core.Services.ServiceCreation.Parsing;

/// <summary>
/// Multi-strategy parser for ServiceCreation requirements.
...
public class RequirementsParser
{
    ...
    private async Task<Dictionary<string, object?>?> TryExtractWithLLMAsync(string input)
    {
        ...
        try
        {
            var prompt = $@"Extract ServiceCreation requirements from this text: '{input}'
