    ...
    public class EnvironmentManagementEngine : IEnvironmentManagementEngine
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                try
                {
                    var resources = await _azureResourceService.ListAllResourcesInResourceGroupAsync(subscriptionId, resourceGroup, cancellationToken);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            foreach (var rg in resourceGroups)
            {
                ...
                var resources = await _azureResourceService.ListAllResourcesInResourceGroupAsync(filter.SubscriptionId, rgName, cancellationToken);
