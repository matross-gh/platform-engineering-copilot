...
/// <summary>
/// Unit tests for IncidentResponseScanner
/// Tests scanning for IR control family
/// </summary>
public class IncidentResponseScannerTests
{
    private readonly Mock<ILogger<IncidentResponseScanner>> _loggerMock;
    private readonly Mock<IAzureResourceService> _azureServiceMock;
    private readonly IncidentResponseScanner _scanner;
    private const string TestSubscriptionId = "test-subscription-id";

    public IncidentResponseScannerTests()
    {
        _loggerMock = new Mock<ILogger<IncidentResponseScanner>>();
        _azureServiceMock = new Mock<IAzureResourceService>();
        _scanner = new IncidentResponseScanner(_loggerMock.Object, _azureServiceMock.Object);
    }
    ...
    {
        // Act
        var scanner = new IncidentResponseScanner(_loggerMock.Object, _azureServiceMock.Object);
    ...
    {
        // Act
        var act = () => new IncidentResponseScanner(null!, _azureServiceMock.Object);
    ...
    {
        // Act
        var act = () => new IncidentResponseScanner(_loggerMock.Object, null!);
    ...
    {
        // Arrange
        var control = new NistControl { Id = "IR-4", Title = "Incident Handling" };
    ...
    [Theory]
    [InlineData("IR-1", "Incident Response Policy")]
    [InlineData("IR-2", "Incident Response Training")]
    [InlineData("IR-4", "Incident Handling")]
    [InlineData("IR-5", "Incident Monitoring")]
    [InlineData("IR-6", "Incident Reporting")]
    [InlineData("IR-8", "Incident Response Plan")]
    public async Task ScanControlAsync_WithVariousIRControls_Succeeds(string controlId, string title)
    {
        // Arrange
