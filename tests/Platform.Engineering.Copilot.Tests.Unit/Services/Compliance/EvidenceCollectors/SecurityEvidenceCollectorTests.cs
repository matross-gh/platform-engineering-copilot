...
/// <summary>
/// Unit tests for SecurityEvidenceCollector
/// Tests evidence collection for SC control family
/// </summary>
public class SecurityEvidenceCollectorTests
{
    private readonly Mock<ILogger<SecurityEvidenceCollector>> _loggerMock;
    private readonly Mock<IAzureResourceService> _azureServiceMock;
    private readonly SecurityEvidenceCollector _collector;
    private const string TestSubscriptionId = "test-subscription-id";
    private const string TestControlFamily = "SC";
    private const string TestCollectedBy = "test-collector";

    public SecurityEvidenceCollectorTests()
    {
        _loggerMock = new Mock<ILogger<SecurityEvidenceCollector>>();
        _azureServiceMock = new Mock<IAzureResourceService>();
        _collector = new SecurityEvidenceCollector(_loggerMock.Object, _azureServiceMock.Object);
    }
    ...
    {
        // Act
        var collector = new SecurityEvidenceCollector(_loggerMock.Object, _azureServiceMock.Object);
    ...
    {
        // Act
        var act = () => new SecurityEvidenceCollector(null!, _azureServiceMock.Object);
    ...
    {
        // Act
        var act = () => new SecurityEvidenceCollector(_loggerMock.Object, null!);
