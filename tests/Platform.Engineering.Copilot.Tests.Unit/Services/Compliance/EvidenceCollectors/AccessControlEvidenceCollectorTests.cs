...
/// <summary>
/// Unit tests for AccessControlEvidenceCollector
/// Tests evidence collection for AC control family
/// </summary>
public class AccessControlEvidenceCollectorTests
{
    private readonly Mock<ILogger<AccessControlEvidenceCollector>> _loggerMock;
    private readonly Mock<IAzureResourceService> _azureServiceMock;
    private readonly AccessControlEvidenceCollector _collector;
    ...
    public AccessControlEvidenceCollectorTests()
    {
        _loggerMock = new Mock<ILogger<AccessControlEvidenceCollector>>();
        _azureServiceMock = new Mock<IAzureResourceService>();
        _collector = new AccessControlEvidenceCollector(_loggerMock.Object, _azureServiceMock.Object);
    }
    ...
    {
        // Act
        var collector = new AccessControlEvidenceCollector(_loggerMock.Object, _azureServiceMock.Object);
    ...
    {
        // Act
        var act = () => new AccessControlEvidenceCollector(null!, _azureServiceMock.Object);
    ...
    {
        // Act
        var act = () => new AccessControlEvidenceCollector(_loggerMock.Object, null!);
