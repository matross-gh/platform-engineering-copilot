...
/// <summary>
/// Unit tests for IdentificationAuthenticationEvidenceCollector
/// Tests evidence collection for IA control family
/// </summary>
public class IdentificationAuthenticationEvidenceCollectorTests
{
    private readonly Mock<ILogger<IdentificationAuthenticationEvidenceCollector>> _loggerMock;
    private readonly Mock<IAzureResourceService> _azureServiceMock;
    private readonly IdentificationAuthenticationEvidenceCollector _collector;
    private const string TestSubscriptionId = "test-subscription-id";
    private const string TestControlFamily = "IA";
    private const string TestCollectedBy = "test-collector";

    public IdentificationAuthenticationEvidenceCollectorTests()
    {
        _loggerMock = new Mock<ILogger<IdentificationAuthenticationEvidenceCollector>>();
        _azureServiceMock = new Mock<IAzureResourceService>();
        _collector = new IdentificationAuthenticationEvidenceCollector(_loggerMock.Object, _azureServiceMock.Object);
    }
    ...
    {
        // Act
        var collector = new IdentificationAuthenticationEvidenceCollector(_loggerMock.Object, _azureServiceMock.Object);
    ...
    {
        // Act
        var act = () => new IdentificationAuthenticationEvidenceCollector(null!, _azureServiceMock.Object);
    ...
    {
        // Act
        var act = () => new IdentificationAuthenticationEvidenceCollector(_loggerMock.Object, null!);
