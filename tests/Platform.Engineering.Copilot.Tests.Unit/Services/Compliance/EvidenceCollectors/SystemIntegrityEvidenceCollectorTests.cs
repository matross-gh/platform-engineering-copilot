...
/// <summary>
/// Unit tests for SystemIntegrityEvidenceCollector
/// Tests evidence collection for SI control family
/// </summary>
public class SystemIntegrityEvidenceCollectorTests
{
    private readonly Mock<ILogger<SystemIntegrityEvidenceCollector>> _loggerMock;
    private readonly Mock<IAzureResourceService> _azureServiceMock;
    private readonly SystemIntegrityEvidenceCollector _collector;
    private const string TestSubscriptionId = "test-subscription-id";
    private const string TestControlFamily = "SI";
    private const string TestCollectedBy = "test-collector";

    public SystemIntegrityEvidenceCollectorTests()
    {
        _loggerMock = new Mock<ILogger<SystemIntegrityEvidenceCollector>>();
        _azureServiceMock = new Mock<IAzureResourceService>();
        _collector = new SystemIntegrityEvidenceCollector(_loggerMock.Object, _azureServiceMock.Object);
    }
    ...
    {
        // Act
        var collector = new SystemIntegrityEvidenceCollector(_loggerMock.Object, _azureServiceMock.Object);
    ...
    {
        // Act
        var act = () => new SystemIntegrityEvidenceCollector(null!, _azureServiceMock.Object);
    ...
    {
        // Act
        var act = () => new SystemIntegrityEvidenceCollector(_loggerMock.Object, null!);
