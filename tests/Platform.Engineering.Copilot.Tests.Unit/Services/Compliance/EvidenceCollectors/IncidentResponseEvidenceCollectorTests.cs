...
/// <summary>
/// Unit tests for IncidentResponseEvidenceCollector
/// Tests evidence collection for IR control family
/// </summary>
public class IncidentResponseEvidenceCollectorTests
{
    private readonly Mock<ILogger<IncidentResponseEvidenceCollector>> _loggerMock;
    private readonly Mock<IAzureResourceService> _azureServiceMock;
    private readonly IncidentResponseEvidenceCollector _collector;
    private const string TestSubscriptionId = "test-subscription-id";
    private const string TestControlFamily = "IR";
    private const string TestCollectedBy = "test-collector";

    public IncidentResponseEvidenceCollectorTests()
    {
        _loggerMock = new Mock<ILogger<IncidentResponseEvidenceCollector>>();
        _azureServiceMock = new Mock<IAzureResourceService>();
        _collector = new IncidentResponseEvidenceCollector(_loggerMock.Object, _azureServiceMock.Object);
    }
    ...
    {
        // Act
        var collector = new IncidentResponseEvidenceCollector(_loggerMock.Object, _azureServiceMock.Object);
    ...
    {
        // Act
        var act = () => new IncidentResponseEvidenceCollector(null!, _azureServiceMock.Object);
    ...
    {
        // Act
        var act = () => new IncidentResponseEvidenceCollector(_loggerMock.Object, null!);
